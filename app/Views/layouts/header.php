            ...
            <div class="navbar-container content">
                <div class="collapse navbar-collapse" id="navbar-mobile">
                    ...
                    <ul class="nav navbar-nav float-right">
                        <li class="dropdown dropdown-user nav-item"><a class="dropdown-toggle nav-link dropdown-user-link" href="#" data-toggle="dropdown"><span class="mr-1 user-name text-bold-700">Fitri Aulia</span><span class="avatar avatar-online"><img src="<?= base_url() ?>/images/avatar-s-19.png" alt="avatar"><i></i></span></a>
