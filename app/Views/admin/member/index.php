                                            ...
                                            <tbody>
                                                <?php foreach ($data as $key => $value) { ?>
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <a href="#" class="btn btn-warning btn-sm btn-edit" data-id-siswa="<?= $value->id_siswa ?>" data-id-registrasi="<?= $value->id_registrasi ?>" data-username="<?= $value->username ?>" data-password="<?= $value->password ?>" data-nama-siswa="<?= $value->nama_siswa ?>" data-alamat="<?= $value->alamat ?>" data-kelas="<?= $value->kelas ?>" data-nomor-telepon="<?= $value->nomor_telepon ?>" data-nomor-anggota="<?= $value->nomor_anggota ?>" data-tanggal-daftar="<?= $value->tanggal_daftar ?>">Edit</a>
                                                            <!-- Delete With data-id -->
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="username" placeholder="Nama Belakang" required>
                    </div>
                    <div class="form-group">
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="form-group">
                        <label>Nama Siswa</label>
                        <input type="text" class="form-control nama_siswa" name="nama_siswa" placeholder="Nama Siswa" required>
                    </div>
                    <div class="form-group">
                        <label>Username</label>
                        <input type="text" class="form-control username" name="username" placeholder="Nama Belakang" required>
                    </div>
                    <div class="form-group">
                        <label>Password</label>
                    ...
                    <div class="form-group">
                        <label>Kelas</label>
                        <input type="text" class="form-control kelas" name="kelas" placeholder="Kelas" required>
                    </div>
                    <div class="form-group">
                        <label>Nomor Anggota</label>
                    ...
                    <div class="form-group">
                        <label>Nomor Telepon</label>
                        <input type="text" class="form-control nomor_telepon" name="nomor_telepon" placeholder="Nomor Telepon" required>
                    </div>
                </div>
                <div class="modal-footer">
